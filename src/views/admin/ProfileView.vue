<template>
  <main>
    ...
    <section
      v-show="form.editToggle"
      class="flex justify-center items-center px-10 text-xl relative"
    >
      <div class="flex absolute right-40 top-20 gap-5 text-white text-2xl">
        <i
          v-show="store.Profile.length"
          class="bx bx-window-close cursor-pointer"
      ...
      >
        ...
        <div class="login-box relative">
          <form @submit.prevent="createProduct">
            ...
            <div
              class="relative w-full border-b-0 outline-none text-center float-left"
            >
              <input
                class="bg-[#3097ed] px-5 py-1 rounded-lg cursor-pointer"
                type="submit"
              />
            </div>
          </form>
    ...
    <section
      v-show="!form.editToggle"
      class="flex justify-center admin_panel items-center px-10 text-xl relative"
      v-for="i in store.Profile"
      :key="i.id"
    >
      <div class="flex absolute right-40 top-20 gap-5 text-white text-2xl">
        <i class="bx bx-pencil cursor-pointer" @click="editModal(i.id)"></i
        ><i
          @click="deleteProduct(i.id)"
          class="bx bx-trash cursor-pointer text-red-500"
        ></i>
      </div>
      <div
        class="lg:w-[80%] shadow-md relative rounded-lg shadow-gray-400 border-t border-gray-500 mr-5 md:min-h-full min-h-[700px] p-5 w-full mt-32 sm:p-10 md:float-left"
      >
        <div class="flex flex-col justify-center items-center relative photo">
          <img
            ...
            :src="
              i.image ||
              'https://t3.ftcdn.net/jpg/01/80/58/26/360_F_180582645_OC9VCIHohTXPFKKas6TKVTQW8ltmHmtV.webp'
            "
            id="photo"
            alt="img"
          />
      ...
      >
        <div class="relative w-full max-w-md max-h-full">
          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            >
              <i
                @click="form.deleteToggle = false"
                class="bx bx-x text-xl font-bold px-1"
              ></i>
            ...
            <div class="p-6 text-center">
              ...
              <button
                ...
                type="button"
                @click="
                  store.deleteProduct(form.deleteId);
                  form.deleteToggle = false;
